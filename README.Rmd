...
```
[![Last-changedate](https://img.shields.io/badge/last%20change-`r gsub('-', '--', Sys.Date())`-brightgreen.svg)](https://github.com/benmarwick/testing/commits/master) 
[![minimal R version](https://img.shields.io/badge/R%3E%3D-`r paste0(sessionInfo()$R.version$major, ".", sessionInfo()$R.version$minor)`-brightgreen.svg)](https://cran.r-project.org/)
[![Licence](https://img.shields.io/github/license/mashape/apistatus.svg)](http://choosealicense.com/licenses/mit/) 
[![Travis-CI Build Status](https://travis-ci.org/benmarwick/testing.png?branch=master)](https://travis-ci.org/benmarwick/testing) 
[![codecov.io](https://codecov.io/github/benmarwick/testing/coverage.svg?branch=master)](https://codecov.io/github/benmarwick/testing?branch=master)
